...
export function fmtError(raw) {
  ...
  if (/không đủ lượt|hết điểm|insufficient|đủ điểm|quota|クレジット|残り|lượt cho video|giảm thời lượng|credit hôm nay|còn \d+ credit/i.test(r)) return A("💳", "Không đủ lượt/điểm", "Giảm giây hoặc đổi nick khác.");
